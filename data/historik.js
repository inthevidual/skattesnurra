// Historisk skattedata 1971–2025 (riksgenomsnitt)
...
export const lowerbracket = [NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, 180300, 197300, 203500, 202700, 221600, 229000, 231600, 238400, 245000, 254700, 271500, 290100, 301000, 308800, 313000, 317700, 328600, 340900, 380200, 384600, 395600, 414000, 426300, 433900, 443300, 443200, 452100, 468700, 504400, 523200, 537200, 554900, 613900, 615300, 625800];

// Övre brytpunkt / värnskatt (from 1999, avskaffad 2020)
export const upperbracket = [NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN, 221600, 229000, 231600, 238400, 389500, 398600, 411100, 430900, 447200, 458900, 465200, 472300, 488600, 507100, 538800, 545200, 560900, 587200, 604700, 615700, 629200, 638800, 651700, 675700, 703000, NaN, NaN, NaN, NaN, NaN, NaN];

// Genomsnittlig kommunalskattesats
export const muntax = [0.2169, 0.2294, 0.2309, 0.2317, 0.2435, 0.2523, 0.2591, 0.2773, 0.2803, 0.2808, 0.2854, 0.287, 0.2908, 0.2922, 0.2928, 0.2924, 0.2935, 0.2946, 0.2969, 0.3001, 0.3, 0.2989, 0.299, 0.2992, 0.3032, 0.3047, 0.3047, 0.3046, 0.3029, 0.3039, 0.3054, 0.3052, 0.3117, 0.3151, 0.316, 0.3159, 0.3156, 0.3144, 0.3152, 0.3156, 0.3155, 0.316, 0.3173, 0.3185, 0.3199, 0.321, 0.3212, 0.3212, 0.3219, 0.3228, 0.3227, 0.3224, 0.3224, 0.3237, 0.3241];

// Prisbasbelopp
export const PBB = [7100, 7300, 7900, 9000, 9700, 10700, 11800, 12600, 13900, 16100, 17300, 17800, 19400, 20300, 21800, 23300, 24100, 25800, 27900, 29700, 32200, 33700, 34400, 35200, 35700, 36200, 36300, 36400, 36400, 36600, 36900, 37900, 38600, 39300, 39400, 39700, 40300, 41000, 42800, 42400, 42800, 44000, 44500, 44400, 44500, 44300, 44800, 45500, 46500, 47300, 47600, 48300, 52500, 57300, 58800];

// Genomsnittlig momsandel (skattens andel av konsumtionen)
export const vatrate = [0.117, 0.119, 0.115, 0.106, 0.116, 0.117, 0.133, 0.131, 0.129, 0.137, 0.133, 0.134, 0.131, 0.146, 0.143, 0.148, 0.149, 0.147, 0.159, 0.178, 0.155, 0.151, 0.155, 0.148, 0.134, 0.173, 0.161, 0.168, 0.168, 0.172, 0.167, 0.172, 0.172, 0.173, 0.178, 0.187, 0.189, 0.193, 0.190, 0.194, 0.192, 0.184, 0.186, 0.186, 0.186, 0.186, 0.186, 0.186, 0.186, 0.186, 0.186, 0.186, 0.186, 0.186, 0.186];

// Konsumentprisindex (2025 = 1.0), källa: SCB KPI årsmedel
export const CPI = [0.106, 0.112, 0.119, 0.131, 0.144, 0.159, 0.176, 0.195, 0.209, 0.237, 0.266, 0.288, 0.314, 0.339, 0.364, 0.38, 0.396, 0.419, 0.446, 0.492, 0.538, 0.551, 0.576, 0.589, 0.604, 0.607, 0.61, 0.609, 0.612, 0.618, 0.633, 0.646, 0.659, 0.662, 0.665, 0.674, 0.688, 0.712, 0.71, 0.72, 0.738, 0.745, 0.745, 0.743, 0.743, 0.75, 0.763, 0.778, 0.792, 0.806, 0.824, 0.89, 0.962, 0.995, 1];
...
export const DECADE_COMMENTARY = {
  ...
  2020: 'Värnskatten avskaffades 2020. Jobbskatteavdraget har höjts i flera steg och avtrappningen för höga inkomster togs bort 2025. Trots avsaknad av den stora skattereform som utlovades i Januariöverenskommelsen har skatten på arbete sjunkit något under 2020-talet.',
};
